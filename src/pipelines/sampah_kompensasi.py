...
ENDPOINT = "jumlah_kompensasi_penanganan_sampah_di_kota_bandung_1"
TABLE = "sampah_kompensasi"
...
def run() -> int:
    rows = [
        ...
        and row.get("bulan")
        and row.get("kategori_kompensasi")
        and row.get("jumlah_kompensasi") is not None
