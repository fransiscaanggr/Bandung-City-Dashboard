...
ENDPOINT = "volume_tampungan_kolam_retensi_di_kota_bandung_1"
TABLE = "kolam_retensi_volume"
...
def _clean(row: dict) -> dict:
    return {
        ...
        "volume_tampungan_total": to_float(row.get("volume_tampungan_total")),
...
def run() -> int:
    rows = [
        ...
        and row.get("nama")
        and row.get("volume_tampungan_total") is not None
